                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                <div class="md:col-span-1">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $employee->fullName }}</h3>
                                                    ...
                                                    >
                                                        ...
                                                        @foreach($companies as $company)
                                                            @if($company->id == $employee->company->id)
                                                                <option value="{{ $company->id }}" selected class="bg-gray-100 text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">{{ $company->name }}</option>
                                                            @else
